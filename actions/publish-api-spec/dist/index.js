...
class SemVer {
  constructor (version, options) {
    ...
    if (version instanceof SemVer) {
      ...
      throw new TypeError(`Invalid Version: ${__nccwpck_require__(1669).inspect(version)}`)
    }
...
const authenticate = __nccwpck_require__(8326);
const uploadSpecification = __nccwpck_require__(4373);
...
/******/ 	return __nccwpck_require__(3654);
/******/ })()
;